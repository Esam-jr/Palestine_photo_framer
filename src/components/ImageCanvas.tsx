    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          ...
          {/* Main Content - Frames and Preview Side by Side */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xl:gap-8">
            {/* Left Column - Frame Selection */}
            <div className="order-2 lg:order-1">
              {frames.length > 0 && (
                <div className="bg-gray-900 rounded-2xl border border-gray-800 p-4 sm:p-6 shadow-2xl h-fit">
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-gray-900 rounded-2xl border border-gray-800 p-4 sm:p-6 shadow-2xl sticky top-4">
